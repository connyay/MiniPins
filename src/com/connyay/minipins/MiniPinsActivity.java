	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.item3:
			final String[] categories = { "Architecture", "Art",
					...
					"History", "Holidays", "Home", "Humor", "Kids", "MyLife",
					"Women Apparel", "Men Apparel", "Outdoors", "People",
					"Pets", "Photography", "Prints Posters", "Products",
					"Science", "Sports", "Technology", "Travel Places",
					"Wedding Events", "Other" };
		...
		case R.id.item5:
			...
			gift_builder.setItems(gifts, new DialogInterface.OnClickListener() {
				public void onClick(DialogInterface dialog, int item) {
